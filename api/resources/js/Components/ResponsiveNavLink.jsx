        ...
        <Link
            ...
            className={`flex w-full items-start border-l-4 py-2 pe-4 ps-3 ${
                active
                    ...
                    : 'border-transparent text-gray-600 hover:border-gray-300 hover:bg-blue-50 hover:text-gray-800 focus:border-gray-300 focus:bg-blue-50 focus:text-gray-800 dark:text-gray-400 dark:hover:border-gray-600 dark:hover:bg-blue-700 dark:hover:text-gray-200 dark:focus:border-gray-600 dark:focus:bg-blue-700 dark:focus:text-gray-200'
